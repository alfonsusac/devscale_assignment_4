export const GithubButton = () => {
  return (
    <a className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center outline outline-white/10">
      <MdiGithub className="text-2xl text-white/50" />
    </a>
  )
}
// Todo: Move to Icons folder
const MdiGithub = (props) => {
  return (
