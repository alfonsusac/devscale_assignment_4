export const NoteSearch = () => {
  return (
    <div className="grow relative p-1.5 bg-zinc-800 rounded-lg flex items-end focus-within:outline focus-within:outline-white/20">
      <input placeholder="Search..." className="grow p-1 px-2 focus:outline-none bg-inherit placeholder:text-zinc-500" />
      <button className="p-2 text-zinc-200 rounded-md text-lg hover:bg-white hover:text-zinc-800 active:brightness-75 transition">
